...
Tests all MCP tools with correct session management.
"""
...
class OllamaArchonMCPTester:
    ...
    def make_mcp_request(self, method: str, params: Optional[Dict] = None) -> Dict[str, Any]:
        ...
        # Set up headers - session ID goes in header, not body
        headers = {
